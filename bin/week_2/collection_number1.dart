...
Future listData(final List listData, final int pengali) async{
  ...
  /*
  Perulangan untuk mengalikan List 'newData' pada void main dengan nilai 'pengali',
  Perulangan dilakukan dengan mendelay terlebih dahulu program,
  Setelah 2 detik, perulangan akan mengalikan isi List 'newData' dengan 'pengali',
  Ditambahkan 'await' agar program menunggu delay terlebih dahulu sebelum lanjut ke proses selanjutnya, 
  */
